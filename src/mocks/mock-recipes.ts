...
export const recipes: Recipe[] = [
    {
        ...
        instructions: [
            ...
            {
                id: 1,
                description: "stir veggies in the wok until lightly brown",
                prePrep: false,
            },
        ],
    },
    {
        id: "1",
        name: "Brussel Sprout Nourish Bowls",
        prepTime: "10 min",
        cookTime: "30 min",
        description:
            "Delicious bowls full of brussel sprouts, cauliflower, hot honey and other yummy ingredients.",
        serves: 2,
        ingredients: [
        ...
        instructions: [
            ...
            {
                id: 4,
                description: "cook brussel sprouts in air fryer",
                prePrep: false,
            },
            {
                id: 5,
                description: "bake cauliflower in the oven",
                prePrep: false,
            },
